...
When making recommendations or implementing changes:

1. Follow the documented architecture and repository blueprints.
2. Prefer modifying existing components over creating new ones.
3. Keep implementations modular and composable.
4. Minimise repository complexity.
5. Maintain clear separation of responsibilities between components.
6. Ensure all changes have a clear feature or maintenance purpose.
...
- **root**: Marimo notebooks for active exploration (.md files)
...
1. **Exploration** (IPython): Test hypotheses, validate approaches, quick iterations
