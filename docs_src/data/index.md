...
| "Are there known bugs in the generators?" | [Reported code issues](data_generation.md#reported-code-issues) |
...
`metering_kwh`. Renaming them is noted in the [code bug report](data_generation.md#reported-code-issues).
